...
#
#     # SQL 插入语句
#     sql = "INSERT INTO poi_category(poi_id, poi_category) VALUES (%s,%s)"
...
f = open('/home/g19tka20/Downloads/Yelp/Yelp_poi_categories.txt', 'r')
line = f.readline()
while line:
    count += 1
    line = line.split("\n")[0]
...
f = open('/home/g19tka20/Downloads/Yelp/Yelp_poi_categories_error.txt','w')
for er in error:
    f.write(er+"\r\n")
