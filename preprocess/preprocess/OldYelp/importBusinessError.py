...
def insertDB(values, count):
    # 打开数据库连接
    db = pymysql.connect("localhost", "root", "root", "business")
...
f = open('/home/g19tka20/Downloads/yelp_dataset/error.txt', 'r')
line = f.readline()
while line:
    count += 1
    j = json.loads(line)
...
f = open('/home/g19tka20/Downloads/yelp_dataset/error2.txt','w')
for er in error:
    f.write(er+"\r\n")
